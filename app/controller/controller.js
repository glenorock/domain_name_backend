...
const _whois = __importStar(require("./services/whois"));
const _registerDomain = __importStar(require("./services/registerDomain"));
const _renewDomain = __importStar(require("./services/renewDomain"));
const _getContactDomains = __importStar(require("./services/getContactDomains"));
